...
gulp.task("app", function() {
  gulp.src(path.css.file).pipe(gulp.dest(path.css.dest));
  gulp.src(path.js.file).pipe(gulp.dest(path.js.dest));
  gulp
    .src(path.img.all)
    .pipe(
      imagemin({
  ...
  gulp.src(path.fonts.all).pipe(gulp.dest(path.fonts.dest));
  gulp
    .src(path.images.all)
    .pipe(
      imagemin({
  ...
  gulp.src(basePaths.devhtml).pipe(gulp.dest(basePaths.dest));
  gulp
    .src(basePaths.srcsass)
    .pipe(plumber())
    .pipe(sass())
    .pipe(
      autoPref({
...
gulp.task("watch-dev", ["connect"], function() {
  ...
  gulp.watch(
    [basePaths.devcommonheader, basePaths.devcommonfooter],
    ["dev-html"]
  );
